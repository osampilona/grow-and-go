    ...
    <div>
      <div className="w-full h-[90vh] bg-white rounded-3xl flex flex-col justify-between py-6">
        ...
        <div className="flex flex-row gap-8 h-[70%]">
          ...
          <div className="flex items-center justify-center bg-blue-500 rounded-3xl w-2/5 h-full relative">
            <div className="w-[80%] h-[80%] bg-gray-200 rounded-3xl flex items-center justify-center">
              <span className="text-gray-400 text-lg">Product Image</span>
            </div>
            </div>
          {/* Right: Product info area */}
          <div className="flex flex-col justify-center w-3/5 h-full gap-6">
        ...
        <div className="flex flex-row gap-8 w-full h-[30%] mt-8">
          {/* Left suggestion */}
          <div className="bg-white rounded-3xl flex flex-col justify-center p-8 w-2/5 h-full">
          ...
          {/* Right suggestion */}
          <div className="bg-purple-100 rounded-3xl flex items-center gap-8 p-8 w-3/5 h-full">
